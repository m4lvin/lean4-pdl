...
# run lean4checker
echo "Running lean4checker on Pdl"
~/.elan/bin/lake env lean4checker/.lake/build/bin/lean4checker Pdl

echo "Running lean4checker on Bml"
~/.elan/bin/lake env lean4checker/.lake/build/bin/lean4checker Bml
